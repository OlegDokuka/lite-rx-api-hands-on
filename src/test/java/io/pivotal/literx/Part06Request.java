...
//========================================================================================
    ...
    // TODO Create a StepVerifier that requests initially 1 value and expects {@link User.SKYLER} then requests
    // another value and expects {@link User.JESSE}.
...
//========================================================================================
    ...
    Flux<User> fluxWithDoOnPrintln() {
        return repository.findAll()
                ...
                .doOnNext(u -> System.out.format("%s %s\n\r", u.getFirstname(), u.getLastname()))
