...
//========================================================================================
    ...
    // TODO Use StepVerifier to check that the flux parameter emits "foo" and "bar" elements then completes
    // successfully.
...
//========================================================================================
    ...
    // TODO Use StepVerifier to check that the flux parameter emits "foo" and "bar" elements then a RuntimeException
	// error.
...
//========================================================================================
    ...
    // TODO Use StepVerifier to check that the flux parameter emits a User with "swhite" username and another one
	// with "jpinkman" then completes successfully.
    void expectSkylerJesseComplete(Flux<User> flux) {
        StepVerifier.create(flux)
                .expectSubscription()
                .expectNextMatches(u -> u.getUsername().equals("swhite"))
                .consumeNextWith(u -> assertThat(u.getUsername(), equalTo("jpinkman")))
                .expectComplete()
                .verify();
    }
